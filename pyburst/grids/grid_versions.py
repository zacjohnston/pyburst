...
version_defaults = {
    'exclude_any': {
        ...
        'he2': {
            'qnuc': [3.0], 'qb': [0.3, 0.5, 0.6, 0.8], 'mass': [1.4, 2.6],
            'x': [0.001], 'z': [0.005], 'accrate': [0.15],
        },
        'alpha1': {},
        'alpha2': {},
        'mesa': {},
    ...
    'exclude_any':
        {
            ...
            'he2': {
                ...
                3: {
                    ...
                    'x': [0.001, 0.1],  'z': [0.005], 'accrate': [0.15, 0.175],
                },
                4: {
                    'qnuc': [3.0], 'qb': [0.3, 0.5, 0.8], 'mass': [1.4, 2.6], 'x': [0.001],
                    'accrate': [0.4], 'z': [],
                ...
                5: {
                    'qnuc': [3.0], 'qb': [0.05, 0.6, 0.8], 'mass': [1.4, 2.0, 2.6],
                    'x': [0.001, 0.01, 0.03, 0.05, 0.10], 'accrate': [0.15, 0.35, 0.4],
                    'z': [0.005],
                },
            },
            'alpha1': {},
