...
version_defaults = {
    'exclude_any': {
        ...
        'he2': {
            'qnuc': [1.0, 3.0], 'qb': [0.00, 0.4, 0.45, 0.5, 0.55, 0.6, 0.8],
            'mass': [1.1, 1.4, 1.7, 2.6], 'x': [0.001, 0.01, 0.03, 0.05, 0.10],
            'accrate': [0.15, 0.175], 'z': [0.005],
        },
        'alpha1': {},
        'alpha2': {},
        'mesa': {},
    ...
    'exclude_any':
        {
            ...
            'grid5': {
                1: {
                    'accrate': [0.12, 0.16, 0.2], 'z': [0.001, 0.01, 0.015], 'x': [0.74],
                    'qb': [0.05, 0.1, 0.15, 0.3, 0.8], 'mass': [2.5, 2.6, 2.9],
                },
            },
            'grid6': {},
            'synth5': {},
            ...
            'he2': {
                1: {
                    'qnuc': [3.0, 5.0], 'qb': [0.4, 0.45, 0.5, 0.55, 0.6, 0.8],
                    'mass': [1.1, 1.4, 1.7, 2.6], 'x': [0.001, 0.01, 0.03, 0.05, 0.10],
                    'accrate': [0.15, 0.175], 'z': [0.005],
                },
            },
