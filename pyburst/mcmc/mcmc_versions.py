...
initial_position = {
    1: {
        1: (0.085, 0.11, 0.13, 0.7, 0.01, 0.4, 0.2, 0.2, 2.0, 2.0, 7.0, 1.5),
        2: (0.095, 0.13, 0.15, 0.68, 0.015, 0.45, 0.3, 0.3, 2.4, 3.3, 8.1, 2.0),
        3: (0.095, 0.13, 0.15, 0.68, 0.015, 0.45, 0.3, 0.3, 2.4, 2.0, 8.1, 2.0),
        4: (0.095, 0.13, 0.15, 0.68, 0.015, 0.45, 0.3, 0.3, 2.4, 1.8, 8.1, 2.0),
    },
    2: {
        1: (0.085, 0.7, 0.01, 0.4, 2.0, 2.0, 7.0, 1.5),
        2: (0.11,  0.7, 0.01, 0.2, 2.0, 2.0, 7.0, 1.5),
        3: (0.13,  0.7, 0.01, 0.2, 2.0, 2.0, 7.0, 1.5),
    },
    3: {
        1: (0.28, 0.36, 0.11, 0.07, 1.6, 2.0, 7.8, 1.5),
        2: (0.3, 0.4, 0.1, 0.06, 1.6, 1.8, 7.7, 1.3),
        3: (0.35, 0.48, 0.07, 0.03, 1.9, 2.0, 8.3, 1.5),
        4: (0.25, 0.4, 0.13, 0.04, 1.7, 2.0, 7.8, 2.0),
    },
    4: {
        ...
        7: (0.25, 0.13, 1.7, 2.0, 7.8, 2.0),
        8: (0.40, 0.04, 1.7, 2.0, 7.8, 2.0),
    },
}
