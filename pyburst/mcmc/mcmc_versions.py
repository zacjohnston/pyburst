...
initial_position = {
    1: {
        1: (0.102, 0.138, 0.162, 0.71, 0.005, 0.075, 1.5, 1.35, 0.55, 1.3),
    },

    2: {
        1: (0.105, 0.13, 0.15, 0.72, 0.005, 1.3, 1.35, 0.51, 1.2),
    },

    3: {
        1: (0.105, 0.13, 0.15, 0.72, -0.5, 0.075, 1.3, 1.35, 0.51, 1.2),
    },

    4: {
        1: (0.102, 0.14, 0.165, 0.7, 0.004, 0.058, 0.062, 0.14, 1.5, 1.33, 0.55, 1.3),
        2: (0.12, 0.12, 0.12,  0.7, 0.005, 0.1, 0.1, 0.1, 1.3, 1.3, 1., 2.3), # (priors only test)
        3: (0.102, 0.14, 0.165, 0.728, 0.007, 0.01, 0.01, 0.09, 1.6, 1.33, 0.55, 1.3),
    },
    ...
    6: {
      1: (0.23, 0.36, 0.04, 0.008, 0.25, 0.12, 1.2, 1.4, 5.0, 1.0),
    },
